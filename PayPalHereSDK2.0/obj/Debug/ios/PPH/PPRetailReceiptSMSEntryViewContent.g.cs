...
namespace PPH {
	[Register("PPRetailReceiptSMSEntryViewContent", true)]
	public unsafe partial class PPRetailReceiptSMSEntryViewContent : PPRetailObject {
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("PPRetailReceiptSMSEntryViewContent");
		...
		[Export ("init")]
		public PPRetailReceiptSMSEntryViewContent () : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected PPRetailReceiptSMSEntryViewContent (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinitions.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal PPRetailReceiptSMSEntryViewContent (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinitions.Messaging.this_assembly;
		}
