...
namespace PPH {
	[Register("PPRetailPayPalErrorInfo", true)]
	public unsafe partial class PPRetailPayPalErrorInfo : PPRetailObject {
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("PPRetailPayPalErrorInfo");
		...
		[Export ("init")]
		public PPRetailPayPalErrorInfo () : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected PPRetailPayPalErrorInfo (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinitions.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal PPRetailPayPalErrorInfo (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinitions.Messaging.this_assembly;
		}
